...
public class Controller {
	...
	private Rifornimenti rifornimenti=new Rifornimenti();
...
/******************************************************************************************************************/	
	...
	public void registraRifornimento() {
		...
		rifornimenti.addRifornimento(numeroScatole,tipoCialda);
...
/******************************************************************************************************************/	
	...
	public void saveAllInFile(Connection c) throws SQLException {
			cassa.print(c);
			magazzino.print(c);
			personale.print(c);
			vendite.print(c);
			rifornimenti.print(c);
	}
